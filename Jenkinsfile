        ...
        stage('BUILD Docker Image') {
            steps {
                script {
                    ...
                    sh 'ls -l'
                    sh 'docker images'
                    sh 'cd server && ls -lRa /var/snap/docker/common/var-lib-docker/tmp/ && pwd && docker build -t romainc75/productivity-app:server-latest --progress=plain --file ./Dockerfile .'
